<div>
    ...
    {{-- Pie Chart --}}
    <div class="max-w-sm w-full flex-auto bg-white rounded-lg col-span-1 shadow-sm dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between items-start w-full">
            <div class="flex-col items-center">
                <div class="flex items-center mb-1">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Attendance Pie Chart</h5>
        ...
        <!-- Line Chart -->
        <div class="max-w-sm w-full flex-auto bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">

        <div class="py-18" id="pie-chart"></div>
