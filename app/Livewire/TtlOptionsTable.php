...
class TtlOptionsTable extends DataTableComponent
{
    protected $model = TtlOptions::class;
    ...
    public function columns(): array
    {
        return [
            Column::make("Id", "id")
                ->sortable(),
            Column::make("TTL Connection", "ttl_respond")
                ->sortable(),
            Column::make("System Action", "system_action")
                ->sortable(),
